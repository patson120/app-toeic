...
<script setup lang="ts">
    import { LinkedinIcon, FacebookIcon } from "lucide-vue-next";

    const featureCards = [
    {
        title: "TOEIC Training",
        description:
        "Application conviviale qui simplifie l'apprentissage même pour les plus petits.",
    },
    {
        title: "Career Boost RH.",
        description: "T",
    },
    ];
</script>